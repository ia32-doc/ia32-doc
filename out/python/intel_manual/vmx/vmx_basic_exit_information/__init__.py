...
class VmxExitQualificationCrAccess(with_metaclass(BitFieldMeta, BitField)):
...
class VmxExitQualificationDrAccess(with_metaclass(BitFieldMeta, BitField)):
...
class VmxExitQualificationIoInst(with_metaclass(BitFieldMeta, BitField)):
