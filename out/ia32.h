...
#define CR4_USERMODE_INSTRUCTION_PREVENTION(_)                       (((_) >> 11) & 0x01)
     ...
     * IA32-e mode, the processor uses 4-level paging to translate 48-bit linear addresses. This bit cannot be modified in
     * IA-32e mode.
     */
    UINT64 La57Enable                                              : 1;
...
#define CR4_OS_XSAVE(_)                                              (((_) >> 18) & 0x01)
    ...
    /**
     * @brief When set, the LOADIWKEY instruction is enabled
     *
     ...
     * are enabled.
     * When clear, CPUID.19H:EBX.AESKLE[bit 0] is enumerated as 0 and execution of any Key Locker instruction causes an
     * invalid-opcode exception (\#UD).
     */
    UINT64 KlEnable                                                : 1;
#define CR4_KL_ENABLE_BIT                                            19
#define CR4_KL_ENABLE_FLAG                                           0x80000
#define CR4_KL_ENABLE_MASK                                           0x01
#define CR4_KL_ENABLE(_)                                             (((_) >> 19) & 0x01)
...
#define CR4_PROTECTION_KEY_ENABLE(_)                                 (((_) >> 22) & 0x01)
    ...
    /**
     * @brief Enables control-flow enforcement technology when set
     *
     ...
     */
    UINT64 CetEnable                                               : 1;
#define CR4_CET_ENABLE_BIT                                           23
#define CR4_CET_ENABLE_FLAG                                          0x800000
#define CR4_CET_ENABLE_MASK                                          0x01
#define CR4_CET_ENABLE(_)                                            (((_) >> 23) & 0x01)

    /**
     * @brief Associate supervisor-mode linear addresses with a protection key
     *
     * [Bit 24] 4-level paging and 5-level paging associate each supervisor-mode linear address with a protection key. When
     * set, this flag alloows use of the IA32_PKRS MSR to specify, for each protection key, whether supervisor-mode linear
     * addresses with that protection key can be read or written.
     */
    UINT64 PksEnable                                               : 1;
#define CR4_PKS_ENABLE_BIT                                           24
#define CR4_PKS_ENABLE_FLAG                                          0x1000000
#define CR4_PKS_ENABLE_MASK                                          0x01
#define CR4_PKS_ENABLE(_)                                            (((_) >> 24) & 0x01)
    UINT64 Reserved2                                               : 39;
  };
